...
json_file_final_refined_data = open(os.path.join(sys.path[0], "final_refined_data/EURUSD_MSI_SS1_1H4H1D_RRR1-1_2024/buys_and_sells.json"), "r")
...
for month in json_refinened_data:
    for trade in json_refinened_data[month]:
        ...
        stop_loss_price = get_stop_loss_pips(trade_type, entry_price, stop_loss_price)
        take_profit_price = get_take_profit_in_pips(trade_type, entry_price, take_profit_price)
...
with open("information/EURUSD_MSI_SS1_1H4H1D_RRR1-1_2024/5.scatter_plot_buys_and_sells.json", "w") as file:
