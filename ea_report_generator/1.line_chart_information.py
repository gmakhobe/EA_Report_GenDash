...
json_file_final_refined_data = open(os.path.join(sys.path[0], "final_refined_data/EURUSD_MSI_WeakSignal1_2024/buys_and_sells_eurusd.json"), "r")
...
with open("information/EURUSD_MSI_WeakSignal1_2024/1.line_buys_and_sells_eurusd.json", "w") as file:
