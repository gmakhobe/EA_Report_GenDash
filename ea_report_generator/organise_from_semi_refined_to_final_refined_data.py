...
json_file_deals = open(os.path.join(sys.path[0], "semi_refined_data/EURUSD_MSI_WeakSignal1_2024/deals_sells_eurusd.json"), "r")
json_file_orders = open(os.path.join(sys.path[0], "semi_refined_data/EURUSD_MSI_WeakSignal1_2024/orders_sells_eurusd.json"), "r")
...
with open("final_refined_data/EURUSD_MSI_WeakSignal1_2024/buys_and_sells_eurusd.json", "w") as file:
