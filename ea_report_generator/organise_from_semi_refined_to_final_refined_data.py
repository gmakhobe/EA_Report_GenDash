...
json_file_deals = open(os.path.join(sys.path[0], "semi_refined_data/EURUSD_MSI_SS1_1H4H1D_RRR1-1_2024/deals.json"), "r")
json_file_orders = open(os.path.join(sys.path[0], "semi_refined_data/EURUSD_MSI_SS1_1H4H1D_RRR1-1_2024/orders.json"), "r")
...
with open("final_refined_data/EURUSD_MSI_SS1_1H4H1D_RRR1-1_2024/buys_and_sells.json", "w") as file:
