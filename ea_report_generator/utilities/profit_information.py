class ProfitInformation:
  ...
  def process_profit(self, term_divider):
    ...
    april = self.calculate_profit(self.data["April"])
    may = self.calculate_profit(self.data["May"])
    june = self.calculate_profit(self.data["June"])
    july = self.calculate_profit(self.data["July"])
    august = self.calculate_profit(self.data["August"])
    september = self.calculate_profit(self.data["September"])
    october = self.calculate_profit(self.data["October"])
    november = self.calculate_profit(self.data["November"])
    december = self.calculate_profit(self.data["December"])
    ...
    if term_divider == 6:
      self.semesterly_profit = {
        "first_simester": {
          "gross_profit": january["gross_profit"] + february["gross_profit"] + march["gross_profit"] + april["gross_profit"] + may["gross_profit"] + june["gross_profit"],
          "gross_loss": january["gross_loss"] + february["gross_loss"] + march["gross_loss"] + april["gross_loss"] + may["gross_loss"] + june["gross_loss"],
          "gross_reward": january["gross_reward"] + february["gross_reward"] + march["gross_reward"] + april["gross_reward"] + may["gross_reward"] + june["gross_reward"],
          "gross_risk": january["gross_risk"] + february["gross_risk"] + march["gross_risk"] + april["gross_risk"] + may["gross_risk"] + june["gross_risk"],
          "net_profit": january["net_profit"] + february["net_profit"] + march["net_profit"] + april["net_profit"] + may["net_profit"] + june["net_profit"],
          "net_reward": january["net_reward"] + february["net_reward"] + march["net_reward"] + april["net_reward"] + may["net_reward"] + june["net_reward"]
        },
        "second_simester": {
          "gross_profit": july["gross_profit"] + august["gross_profit"] + september["gross_profit"] + october["gross_profit"] + november["gross_profit"] + december["gross_profit"],
          "gross_loss": july["gross_loss"] + august["gross_loss"] + september["gross_loss"] + october["gross_loss"] + november["gross_loss"] + december["gross_loss"],
          "gross_reward": july["gross_reward"] + august["gross_reward"] + september["gross_reward"] + october["gross_reward"] + november["gross_reward"] + december["gross_reward"],
          "gross_risk": july["gross_risk"] + august["gross_risk"] + september["gross_risk"] + october["gross_risk"] + november["gross_risk"] + december["gross_risk"],
          "net_profit": july["net_profit"] + august["net_profit"] + september["net_profit"] + october["net_profit"] + november["net_profit"] + december["net_profit"],
          "net_reward": july["net_reward"] + august["net_reward"] + september["net_reward"] + october["net_reward"] + november["net_reward"] + december["net_reward"]
        }
      }
    

  def calculate_profit(self, data_list):
