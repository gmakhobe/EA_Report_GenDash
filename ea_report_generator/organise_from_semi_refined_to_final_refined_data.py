...
json_file_deals = open(os.path.join(sys.path[0], "semi_refined_data/XAUUSD/deals_sells_xauusd.json"), "r")
json_file_orders = open(os.path.join(sys.path[0], "semi_refined_data/XAUUSD/orders_sells_xauusd.json"), "r")
...
with open("final_refined_data/XAUUSD/sells_xauusd.json", "w") as file:
